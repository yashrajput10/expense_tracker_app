...
export const card = <i className="tras fa-brands fa-cc-visa"></i>
...
export const trash = <i class="tras fa-solid fa-trash"></i>
export const signout = <i className="tras fa-solid fa-right-from-bracket"></i>
